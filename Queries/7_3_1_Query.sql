...
-- Retirement eligibility, refactored and refined
...
-- Create a new table to display Employee Information (emp_no, last_name,
...
-- Create a new table to display Management Information; Managers per Dept
-- (emp_no, last_name, first_name, hire_date, to_date)
SELECT dm.dept_no,
	   d.dept_name,
	   dm.emp_no,
	   ce.last_name,
...
-- Create a new table to display Department Retirees
...
-- Query returns emp_no, first_name, last_name, dept_name by JOINing
-- retirement_info and departments
SELECT ri.emp_no,
ri.first_name,
ri.last_name,
d.dept_name
